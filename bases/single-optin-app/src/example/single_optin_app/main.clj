(ns example.single-optin-app.main
  (:require [com.biffweb :as biff]
            ...
            [example.home.interface.single-optin.interface :as home-single-optin]

            [example.db.interface :as db]
            [example.db.interface.single-optin.interface :as db-single-optin]

            [example.auth.interface.single-optin.interface :as auth])
...
(def home-options
  #:biff.home{:signup-form home-single-optin/signup-form
              :signin-form home-single-optin/signin-form})
